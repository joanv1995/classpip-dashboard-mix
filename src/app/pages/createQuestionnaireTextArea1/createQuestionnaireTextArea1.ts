...
@Component({
  ...
  templateUrl: './createQuestionnaireTextArea1.html',
  styleUrls: ['./createQuestionnaireTextArea1.scss']
})
export class CreateQuestionnaireTextArea1Component implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateQuestionnaireTextArea1Component>,
